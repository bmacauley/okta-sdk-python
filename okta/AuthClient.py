...
#        kwargs['pathname'] = '/api/v1/authn'
    ...
    def authenticate(self, username, password,
                     relay_state=None, response_type=None,
                     force_mfa=None, context=None):
        ...
        :param response_type: the type of session to return (session_token or
        session_token_url usually)
        :type response_type: str
        :param force_mfa: whether to force mfa even if the auth is exempt
        :type force_mfa: bool
        :param context: contextual info about the auth request like ip and
        location
        :type context: Context
        :rtype: AuthResult
        """
        url_path = '/api/v1/authn'
    ...
    def auth_with_factor(self, state_token, factor_id, passcode,
        ...
        response = ApiClient.post_path(self, url_path,
                                       request, params=params)
        return Utils.deserialize(response.text, AuthResult)

    # MFA MANAGEMENT

    def enroll_factor(self, state_token, factor_type, provider,
                      profile, relay_state=None):
        """Enroll in an MFA factor during the auth flow. Usually only
        encountered if MFA is required for authentication

        :param state_token: current state token from the previous AuthResult
        :type state_token: str
        :param factor_type: type of factor (sms, token, question,
        token:software:totp, token:hardware etc)
    ...
    def activate_factor(self, state_token, factor_id,
                        passcode, relay_state=None):
    ...
    def resend_code(self, state_token, factor_id, relay_state=None):
        ...
        url_path = '/api/v1/authn/factors\
                    /{0}/lifecycle/resend'.format(factor_id)
    ...
    def change_password(self, state_token, old_password, new_password,
                        relay_state=None):
    ...
    def reset_password(self, state_token, new_password, relay_state=None):
        ...
        url_path = '/api/v1/authn/credentials/reset_password'
    ...
    def forgot_password(self, username, relay_state=None):
        ...
        :param username: user's username
        :type username: str
        :param relay_state: data that will persist for
        the lifetime of the authentication or recovery token
        :type relay_state: str or None
        :rtype: AuthResult
        """

        url_path = '/api/v1/authn/recovery/password'
    ...
    def forgot_password_answer(self, state_token, security_answer,
                               new_password, relay_state=None):
    ...
    def validate_recovery_token(self, recovery_token, relay_state=None):
        ...
        :param recovery_token: token distributed to end-user via
        out-of-band mechanism such as email
        :type recovery_token: str
        :param relay_state: data that will persist for the lifetime of
        the authentication or recovery token
        :type relay_state: str or None
        :rtype: AuthResult
        """

        url_path = '/api/v1/authn/recovery/token'
    ...
    def unlock_account(self, username, relay_state=None):
        ...
        url_path = '/api/v1/authn/recovery/unlock'
    ...
    def unlock_account_answer(self, state_token,
                              security_answer, relay_state=None):
    ...
    def previous_state(self, state_token, relay_state=None):
        ...
        :param state_token: current state token from the previous AuthResult
        :type state_token: str
        :param relay_state: data that will persist for the lifetime of th
        authentication or recovery token
        :type relay_state: str or None
        :rtype: AuthResult
        """

        url_path = '/api/v1/authn/previous'
    ...
    def verify_transaction(self, factor_id, transaction_id, user_response):
        ...
        url_path = '/api/v1/authn/factors\
                     /{0}/transactions/{1}/verify'.format(factor_id,
                                                          transaction_id)
